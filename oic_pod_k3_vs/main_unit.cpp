...
//                MainTimer->Enabled = true;
        ...
        GetProgramData();
                ...
                if (gor_act == 0) ActGorImage->Top = 225;
                else
                if (gor_act == 1) ActGorImage->Top = 319;
                else
                if (gor_act == 2) ActGorImage->Top = 413;
                else
                if (gor_act == 3) ActGorImage->Top = 507;
                else
                if (gor_act == 4) ActGorImage->Top = 601;
